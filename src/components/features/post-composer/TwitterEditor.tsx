...
export function TwitterEditor({ content, onChange, disabled }: TwitterEditorProps) {
  const { t } = useTranslation();
  const maxChars = CHAR_LIMITS.twitter;
  ...
  return (
    <div className="space-y-3">
      ...
      <Textarea
        ...
        placeholder={t('composer.editor.placeholderTwitter')}
        disabled={disabled}
        className={cn(
